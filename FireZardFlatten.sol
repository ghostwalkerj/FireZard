    ...
    ERC165Upgradeable
{
    ...
    function __AccessControl_init_unchained(address addy) internal initializer {
        _setupRole(0x00, addy);
    }
    ...
    TimelockControllerUpgradeable
{
    ...
    function FZ_initialize() public initializer {
    ...
    function setNumOfTransactions(uint256 _numOfTransactions)
        external
        returns (uint256)
    {
    ...
    function addToMainAdmin(address addy) external onlyOwner returns (bool) {
        mainAdmin.push(addy);
        mainAdmin.length + 1;
    }
}

// File contracts/FireZard.sol
    ...
    FZ_Dragon
{
    ...
    function buyBackSpecificAmount(uint256 amount) external _onlyOwner() {
        require(amount > 0);
